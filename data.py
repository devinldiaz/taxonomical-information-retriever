digenea = {
    "Schistosoma mansoni": {
        "image": "images/schistosoma_mansoni.jpg",
        "description": "A parasitic worm that causes schistosomiasis",
        "taxonomy": {
    ...
    "Schistosoma haematobium": {
        ...
        "description": "Causes urinary schistosomiasis in humans",
        "taxonomy": {
            "phylum": "Platyhelminthes",
            "class": "Trematoda",
            "order": "Diplostomida",
    ...
    "Schistosoma japonicum": {
        ...
        "description": "Causes intestinal schistosomiasis in humans",
        "taxonomy": {
            "phylum": "Platyhelminthes",
            "class": "Trematoda",
            "order": "Diplostomida",
    ...
    "Fasciola hepatica": {
        ...
        "description": "Causes fascioliasis in livestock and humans",
        "taxonomy": {
            "phylum": "Platyhelminthes",
            "class": "Trematoda",
            "order": "Echinostomida",
    ...
    "Clonorchis sinensis": {
        ...
        "description": "Causes clonorchiasis in humans",
        "taxonomy": {
            "phylum": "Platyhelminthes",
            "class": "Trematoda",
    ...
    "Paragonimus westermani": {
        ...
        "description": "Causes paragonimiasis in humans",
        "taxonomy": {
            "phylum": "Platyhelminthes",
            "class": "Trematoda",
            "order": "Plagiorchiida",
    ...
    "Dicrocoelium dendriticum": {
        ...
        "description": "Causes dicrocoeliasis in livestock",
        "taxonomy": {
            "phylum": "Platyhelminthes",
            "class": "Trematoda",
            "order": "Plagiorchiida",
    ...
    "Ribeiroia ondatrae": {
        ...
        "description": "Causes limb malformations in amphibians",
        "taxonomy": {
            "phylum": "Platyhelminthes",
            "class": "Trematoda",
            "order": "Diplostomida",
    ...
    #     "description":
    #       "Infects birds and snails and causes parasitic castration",
    #     "taxonomy": {
    #         "phylum": "Platyhelminthes",
    #         "class": "Trematoda",
    #         "order": "Diplostomida",
    #     },
    #     "hosts": ["Birds", "Snails"],
    #     "genome": "https://www.ncbi.nlm.nih.gov/.../leucochloridium_variae"
    # }
}

cestoda = {
    "Taenia solium": {
        "image": "images/taenia_solium.jpg",
        "description": "Pork tapeworm causing taeniasis and cysticercosis",
        "taxonomy": {
            "phylum": "Platyhelminthes",
            "class": "Cestoda",
    ...
    "Taenia saginata": {
        ...
        "description": "Beef tapeworm infecting humans and cattle.",
        "taxonomy": {
            "phylum": "Platyhelminthes",
            "class": "Cestoda",
            "order": "Cyclophyllidea",
...
enoplea = {
    "Trichinella spiralis": {
        "image": "images/trichinella_spiralis.jpg",
        "description": "Causes trichinellosis in humans",
        "taxonomy": {
            "phylum": "Nematoda",
            "class": "Enoplea",
