...
with row1[0]:
    st.write(parasite_card("https://www.xpedite-dx.com/fileadmin/benutzerdaten/xpedite-dx-com/bilder/Applications/Microscopy_Schistosoma_mansoni_adult.jpg", "Schistosoma mansoni", "A parasitic worm that causes schistosomiasis in humans, primarily affecting the intestines and liver."))
